...
PATTERNS = [
    ...
    ("極樂", "極樂", None),
    ("心之谷", "心之谷（重映）", None),
    ("看看你有多愛我", "看看你有多愛我", 2025),
    ("贖夢", "贖夢", 2025),
    ("小孩才做選擇", "小孩才做選擇", None),
    ("無形", "無形", None),
    ("NO GOOD", "NO GOOD歐吉桑", 2026),
    ("偷生", "偷生", None),
    ("星與翼的悖論", "星與翼的悖論", None),
    ("好孩子", "好孩子", 2025),
    ("月老", "月老", 2021),
...
MONTHS = {
    "如果愛": 12, "投名狀": 12, "風聲": 9,
    "那些年，我們一起追的女孩": 8, "賽德克·巴萊": 9,
    "陣頭": 1, "痞子英雄系列": 1, "愛的麵包魂": 3, "女朋友。男朋友": 8,
    "逆光飛翔": 9, "血滴子": 12,
    "志氣": 3, "失魂": 8, "變身": 8, "愛情無全順": 11,
    "大稻埕": 1, "鐵獅玉玲瓏": 2, "寒蟬效應": 10,
    "大囍臨門": 2, "奇人密碼：古羅布之謎": 2, "風中家族": 7, "老鷹想飛": 11,
    "大尾鱸鰻2": 2, "我們的那時此刻": 3, "六弄咖啡館": 7, "樓下的房客": 8, "再見瓦城": 12,
    "大釣哥": 1, "目擊者": 3, "報告老師！怪怪怪怪物！": 7, "老師，你會不會回來": 9,
    "美力台灣3D": 12, "帶我去月球": 12,
    "花甲大人轉男孩": 2, "鬥魚": 8, "粽邪": 8, "引爆點": 8, "狂徒": 8, "比悲傷更悲傷的故事": 11,
    "大三元": 2, "切小金家的旅館": 7, "瘋狂電視台瘋電影": 5, "灼人秘密": 12, "黑熊來了": 12,
    "女鬼橋": 2, "打噴嚏": 7, "馗降：粽邪2": 8, "海霧": 9, "孤味": 11, "做工的人": 5, "練愛iNG": 3,
    "迷失安狄 Miss Andy": 1, "複身犯": 4, "當男人戀愛時": 4, "聽見歌 再唱": 4,
    "神之鄉": 7, "月老": 11, "詭扯": 11, "逆局": 10,
    "素還真": 1, "女鬼橋2：怨鬼樓": 5, "快一秒的他": 6, "粽邪3：鬼門開": 8,
    "蒼鷺與少年": 10, "富都青年": 12, "但願人長久": 4, "96分鐘": 9, "生命捕手": 11, "美食無間": 11, "我們六個": 8,
    "NO GOOD歐吉桑": 4, "盜命師": 10, "科學少女": 9, "售命": 4, "童話世界": 10,
    "世外": 10, "贖夢": 4, "人生海海": 4, "看看你有多愛我": 11, "地獄里長": 7,
    "萌學園：尋找磐古": 6, "黑白原來是真的": 10, "順雲": 11, "女優，摔吧！": 11,
    "沒有名字的甜點店": 5, "我的麻吉4個鬼": 8, "愛情算不算": 10, "好孩子": 12, "幻影": 2
}
...
EXCLUDE_FILMS = {"鬼才之道", "小孩才做選擇", "心之谷（重映）", "天使之卵（數位修復版）", "蒼鷺與少年", "催眠麥克風", "愛的迫降（舞台劇）", "森林戰士", "幻影", "贖夢", "廢柴英雄聯盟", OTHER}
...
out = {"films": [{"n": g, "y": y, "m": MONTHS.get(g, 0), "e": est} for g, (y, est) in films.items()],
       "items": manifest}
